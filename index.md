...
[CMU-ARCTIC](http://www.festvox.org/cmu_arctic/)<br>
[NSF](https://www.isca-speech.org/archive/SSW_2019/abstracts/SSW10_O_1-1.html)<br>
[NSF_demo](https://nii-yamagishilab.github.io/samples-nsf/nsf-v3.html)<br>
[PWG](https://ieeexplore.ieee.org/abstract/document/9053795)<br>
[QPPWG](https://ieeexplore.ieee.org/document/9361096)<br>
[QPPWG_demo](https://bigpon.github.io/QuasiPeriodicParallelWaveGAN_demo/)<br>
...
## **Pitch-dependent dilated convolution (see [QPPWG](https://ieeexplore.ieee.org/document/9361096) for details)**
...
<sup>*1. `WORLD: WORLD vocoder (Baseline I)` </sup><br>
<sup>*2. `NSF: Neural Source-Filter vocoder of hn-sinc-nsf9 (Baseline II)` </sup><br>
<sup>*3. `QPPWG_20: QPPWG vocoder with 10 adaptive blocks + 10 fixed blocks (Baseline III)` </sup><br>
<sup>*4. `uSFGAN_60: uSFGAN vocoder with source-network of 30 adaptive blocks + filter-network of 30 fixed blocks` </sup><br>
